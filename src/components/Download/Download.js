...
const Download = () => {
  return (
    <section className="w-full max-w-6xl p-4">
      ...
      <div className="grid md: grid-cols-1 md:grid-cols-6 items-center justify-between py-4">
        ...
        <div className="hidden col-span-1 md:flex justify-center opacity-30 pt-12">
